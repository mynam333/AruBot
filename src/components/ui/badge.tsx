...
export function Badge({
  ...
  return (
    <span className={cn('inline-flex max-w-full shrink-0 items-center justify-center rounded-full border px-2.5 py-1 text-center text-xs font-semibold leading-tight tracking-normal sm:whitespace-nowrap', tones[tone], className)}>
      {children}
    </span>
  );
}
