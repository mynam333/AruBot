...
export const adminNav = [
  ...
  { href: '/video-donations/queue', label: '영상 후원', icon: Clapperboard, group: 'production' },
...
export const adminFeatureMap = {
  ...
  drawingDonations: {
    title: '그림 후원',
    description: '시청자가 그린 그림이 방송 화면 위에서 그려지는 과정까지 살아납니다.',
    endpoint: '/api/drawing-donation/queue',
    icon: ImagePlus,
    actions: [{ href: '/drawing-donations', label: '그림 후원 열기' }],
    tips: ['포인트로 그림을 신청해요', '그리는 과정이 화면에 재생돼요', '불편한 시청자는 차단할 수 있어요'],
  },
  roulette: {
    title: '룰렛',
