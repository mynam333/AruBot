...
const sections = [
  {
    ...
    body: [
      ...
      'AruBot은 소규모 개인 또는 팀 프로젝트로 운영될 수 있으며, 대규모 상용 서비스 수준의 전담 지원, 상시 모니터링, 별도 보증을 제공하지 않을 수 있습니다.',
  ...
  },
  {
    ...
    body: [
      ...
      '로컬 프로그램 정보: 사용자가 선택한 로컬 폴더 경로, 로컬 에셋 목록, 로컬 프로그램 상태. 실제 로컬 파일 원본은 기능 실행에 필요한 경우에 한해 사용자의 PC 또는 로컬 프로그램을 통해 처리될 수 있습니다.',
    ],
  },
  {
    title: '3. 이용 목적',
  ...
  },
  {
    ...
    body: [
      ...
      '외부 서비스 장애, API 정책 변경, 플랫폼 계정 제한, 네트워크 문제 등 AruBot이 직접 통제하기 어려운 사유로 기능이 제한될 수 있습니다.',
    ],
  },
  {
    title: '7. 쿠키와 로컬 저장소',
  ...
  },
  {
    ...
    body: [
      ...
      '다만 개인 또는 소규모 프로젝트 특성상 모든 보안 위협, 외부 서비스 장애, 사용자의 설정 실수, 공개 URL 공유, 로컬 PC 환경 문제를 완전히 방지하거나 보증하지는 않습니다.',
  ...
  },
  {
    title: '10. 책임의 범위',
    body: [
      'AruBot은 관련 법령상 허용되는 범위 내에서, 무료 또는 소규모 운영 서비스로서 기능의 지속성, 외부 플랫폼 연동 성공, 데이터의 무손실 보관, 특정 목적 적합성을 보증하지 않습니다.',
      '사용자의 방송 설정, 공개 링크 공유, 외부 플랫폼 정책 변경, 제3자 서비스 장애, 사용자의 계정 관리 부주의, 로컬 프로그램 실행 환경으로 발생한 문제는 사용자가 함께 관리해야 합니다.',
    ...
    <main className="min-h-screen px-[var(--page-gutter)] py-[clamp(1rem,2.6vw,1.75rem)]">
      ...
      <section className="mx-auto mt-[clamp(2rem,6vw,4rem)] max-w-5xl rounded-[var(--radius-panel)] border bg-[linear-gradient(135deg,hsl(var(--card)),hsl(var(--accent-mint)/0.28)_54%,hsl(var(--accent-sky)/0.22))] p-[clamp(1.25rem,3.5vw,2.5rem)] shadow-soft">
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          ...
          <Badge tone="neutral">소규모 프로젝트 기준</Badge>
        </div>
      </section>
